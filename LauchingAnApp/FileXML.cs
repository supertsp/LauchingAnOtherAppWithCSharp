...
public class FileXML
{
    ...
    private string firstElementName = "settings";
    private string firstAttributeName;
    private string firstAttributeValue;


    #region Constructors
    public FileXML(string url, string fileNameWithoutExtension)
    {
        xml = new XmlDocument();
        fileName = fileNameWithoutExtension;
        _filePath = url + "/" + fileName + ".xml";
        ...
        {
            Console.WriteLine("<<ERROR>> Loading: " + _filePath);
            Console.WriteLine(e);
    ...
    public void SaveAndWriteXMLFile()
    {
